...
public class adminTable extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Users> listUsers = udao.getUser();
        List<Products> listProducts = dao.getListProducts();
        ...
        request.getRequestDispatcher("admin/adminTable.jsp").forward(request, response);
    }
